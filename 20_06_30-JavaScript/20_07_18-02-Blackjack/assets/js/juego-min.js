const miModulo = (() => { "use strict"; let e = []; const t = ["C", "D", "H", "S"],
        ...
        h = e => { let t = 0;
            ...
            t = i(e, 0);
        u(e, 0), t > 21 ? (console.warn("Lo siento mucho, perdiste"), r.disabled = !0, a.disabled = !0, h(t)) : 21 === t && (console.warn("21, Genial!"), r.disabled = !0, a.disabled = !0, h(t)) }), a.addEventListener("click", () => { r.disabled = !0, a.disabled = !0, h(o[0]) }), { nuevoJuego: (t = 2) => { e = d(), o = []; for (let e = 0; e < t; e++) o.push(0);
